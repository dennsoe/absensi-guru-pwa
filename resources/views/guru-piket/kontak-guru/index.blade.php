                ...
                <div class="card-body">
                    <form method="GET" class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Nama, NIP, atau No. Telepon" value="{{ $search ?? '' }}">
                        </div>
                        <div class="col-md-3">
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            ...
                            <span class="badge bg-info">
                                {{ $jadwal->kelas->nama_kelas }} - {{ $jadwal->mataPelajaran->kode_mapel }}
                            </span>
                            @endforeach
                            @if($g->jadwalMengajar->count() > 3)
                            <span class="badge bg-secondary">+{{ $g->jadwalMengajar->count() - 3 }} lainnya</span>
                            @endif
                        </div>
                        @else
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ route('guru-piket.kontak-guru.show', $g->id) }}" class="btn btn-sm btn-primary">
                            <i class="bi bi-eye"></i> Detail
                        </a>
                        @if($g->no_telepon)
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $g->no_telepon) }}" class="btn btn-sm btn-success" target="_blank">
