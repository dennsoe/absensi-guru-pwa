    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('guru-piket.laporan.export-pdf') }}?tanggal={{ $tanggal }}"
        ...
        @if ($laporan->where('belum_absen', '>', 0)->count() > 0)
            <div class="alert alert-warning mt-4">
                ...
                <p class="mb-0">Terdapat {{ $laporan->where('belum_absen', '>', 0)->count() }} guru yang belum melengkapi
                    absensi hari ini. Segera lakukan konfirmasi.</p>
            </div>
        @endif
    </div>
@endsection
