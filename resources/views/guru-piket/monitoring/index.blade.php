                        ...
                        <tbody>
                            @forelse($jadwal as $j)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('guru-piket.monitoring.detail', $j->guru_id) }}"
        ...
        <script>
            function refreshData() {
                ...
                fetch(`{{ route('guru-piket.monitoring.refresh') }}?tanggal=${tanggal}`)
                    ...
                    .then(data => {
                        // Update statistics
                        document.querySelector('#stats-container .col-md-3:nth-child(1) h3').textContent = data.statistics
                            .total_jadwal;
                        document.querySelector('#stats-container .col-md-3:nth-child(2) h3').textContent = data.statistics
                            .sudah_absen;
                        document.querySelector('#stats-container .col-md-3:nth-child(3) h3').textContent = data.statistics
                            .belum_absen;
                        document.querySelector('#stats-container .col-md-3:nth-child(4) h3').textContent = data.statistics
                            .terlambat;
