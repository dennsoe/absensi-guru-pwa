                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group btn-group-sm">
                                    <form action="{{ route('kurikulum.approval.approve', $j->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="btn btn-success" onclick="return confirm('Setujui jadwal ini?')">
                                            <i class="bi bi-check-circle"></i> Approve
                                        </button>
                                    </form>
                                    <form action="{{ route('kurikulum.approval.reject', $j->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="btn btn-danger" onclick="return confirm('Tolak jadwal ini?')">
