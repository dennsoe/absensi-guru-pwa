    ...
    <div class="row">
                    ...
                    <form action="{{ route('kurikulum.jadwal.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ruangan" class="form-control @error('ruangan') is-invalid @enderror" value="{{ old('ruangan') }}" placeholder="Contoh: Lab Komputer">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror" value="{{ old('tahun_ajaran', '2025/2026') }}" required>
        ...
        <div class="col-md-4">
            <div class="alert alert-info">
                ...
                <p class="mb-0 small">Sistem akan otomatis mendeteksi konflik jadwal. Pastikan tidak ada guru yang mengajar pada hari dan jam yang sama.</p>
            </div>
        </div>
    </div>
</div>
