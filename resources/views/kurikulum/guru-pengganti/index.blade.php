                            ...
                            <div class="col-md-3">
                                ...
                                <select name="guru_asli_id" class="form-select" onchange="this.form.submit()">
                                    ...
                                    @foreach ($guru_list as $g)
                                        <option value="{{ $g->id }}"
                                            {{ request('guru_asli_id') == $g->id ? 'selected' : '' }}>{{ $g->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <tbody>
                            @forelse($pengganti as $p)
                                <tr>
                                    ...
                                    <td>{{ substr($p->jadwalMengajar->jam_mulai, 0, 5) }} -
                                        {{ substr($p->jadwalMengajar->jam_selesai, 0, 5) }}</td>
                                    <td>
                                    ...
                                    <td>
                                        @if ($p->status === 'aktif')
                                            <form action="{{ route('kurikulum.guru-pengganti.destroy', $p->id) }}"
