                        ...
                        <table class="table table-sm table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('kepala-sekolah.monitoring.per-kelas', $guru->id) }}" class="btn btn-sm btn-info">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('kepala-sekolah.approval.index') }}" class="btn btn-sm btn-primary">Lihat Semua</a>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="p-3 border-bottom">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <a href="{{ route('kepala-sekolah.approval.show', $izin->id) }}" class="btn btn-sm btn-info">
                                <i class="bi bi-eye"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-warning">{{ ($total_guru_aktif ?? 0) - ($statistics['hadir'] + $statistics['terlambat']) }}</strong>
                    </div>
                </div>
            </div>
        </div>
