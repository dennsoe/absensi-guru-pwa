        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('kepala-sekolah.laporan.export-pdf') }}?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}"
                        ...
                        <tbody>
                            @forelse($laporan as $index => $l)
                                @php
                                    ...
                                    $persentase =
                                        $total > 0 ? (($l->hadir_count + $l->terlambat_count) / $total) * 100 : 0;
                                @endphp
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <strong
                                            class="text-{{ $persentase >= 80 ? 'success' : ($persentase >= 60 ? 'warning' : 'danger') }}">
                                            {{ number_format($persentase, 1) }}%
                                        </strong>
                                    </td>
                                    <td>
                                        <a href="{{ route('kepala-sekolah.analytics.per-guru', $l->id) }}"
