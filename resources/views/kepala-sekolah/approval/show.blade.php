                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <span
                                    class="badge bg-{{ $izin->jenis === 'cuti' ? 'primary' : ($izin->jenis === 'sakit' ? 'warning' : 'info') }} fs-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                {{ \Carbon\Carbon::parse($izin->tanggal_mulai)->diffInDays(\Carbon\Carbon::parse($izin->tanggal_selesai)) + 1 }}
                                hari
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        @if ($izin->status !== 'pending')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    {{ $izin->approved_at ? \Carbon\Carbon::parse($izin->approved_at)->format('d F Y H:i') : '-' }}
                                </div>
                            </div>
                        @endif
            ...
            <div class="col-md-4">
                ...
                @if ($izin->status === 'pending')
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('kepala-sekolah.approval.approve', $izin->id) }}" method="POST"
                                class="mb-3">
                                @csrf
                                <div class="mb-3">
                            ...
                            <form action="{{ route('kepala-sekolah.approval.reject', $izin->id) }}" method="POST"
                                onsubmit="return confirm('Yakin ingin menolak permohonan ini?')">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Alasan Penolakan <span class="text-danger">*</span></label>
                                    <textarea name="alasan_penolakan" class="form-control" rows="3" placeholder="Masukkan alasan penolakan..."
                                        required></textarea>
                                </div>
