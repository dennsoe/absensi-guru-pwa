...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            ...
            <p class="text-muted mb-0">{{ ucfirst(\Carbon\Carbon::now()->dayName) }}, {{ \Carbon\Carbon::now()->format('d F Y') }}</p>
        </div>
    </div>
    ...
    @else
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <div class="card h-100 {{ \Carbon\Carbon::now()->format('H:i') >= substr($j->jam_mulai, 0, 5) && \Carbon\Carbon::now()->format('H:i') <= substr($j->jam_selesai, 0, 5) ? 'border-primary' : '' }}">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            @if(\Carbon\Carbon::now()->format('H:i') >= substr($j->jam_mulai, 0, 5) && \Carbon\Carbon::now()->format('H:i') <= substr($j->jam_selesai, 0, 5))
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <p class="mb-2"><strong>{{ substr($j->jam_mulai, 0, 5) }} - {{ substr($j->jam_selesai, 0, 5) }}</strong></p>
                            </div>
                            <div class="col-6">
                                <p class="mb-1 small text-muted">
