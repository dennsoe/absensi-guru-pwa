                        ...
                        <tbody>
                            @forelse($izin as $i)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $i->jenis === 'cuti' ? 'primary' : ($i->jenis === 'sakit' ? 'warning' : 'info') }}">
                                            {{ strtoupper($i->jenis) }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($i->tanggal_mulai)->diffInDays(\Carbon\Carbon::parse($i->tanggal_selesai)) + 1 }}
                                        hari
                                    </td>
                                    <td>
                                        @if ($i->status === 'pending')
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            @if ($i->status === 'pending')
                                                ...
                                                <form action="{{ route('guru.izin.destroy', $i->id) }}" method="POST"
                                                    class="d-inline" onsubmit="return confirm('Yakin ingin membatalkan?')">
                                                    @csrf
                                                    @method('DELETE')
