                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $izin->jenis === 'cuti' ? 'primary' : ($izin->jenis === 'sakit' ? 'warning' : 'info') }}">
                            ...
                            <tr>
                                <th>Durasi</th>
                                <td>
                                    <strong>{{ \Carbon\Carbon::parse($izin->tanggal_mulai)->diffInDays(\Carbon\Carbon::parse($izin->tanggal_selesai)) + 1 }}
                                        hari</strong>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <form action="{{ route('guru.izin.destroy', $izin->id) }}" method="POST"
                                    onsubmit="return confirm('Yakin ingin membatalkan permohonan?')">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="timeline">
                            <li class="mb-3">
                                <small
                                    class="text-muted">{{ \Carbon\Carbon::parse($izin->created_at)->format('d/m/Y H:i') }}</small>
                                <p class="mb-0 small"><strong>Permohonan diajukan</strong></p>
                            </li>
                            @if ($izin->status !== 'pending')
                                <li>
                                    <small
                                        class="text-muted">{{ \Carbon\Carbon::parse($izin->tanggal_approval)->format('d/m/Y H:i') }}</small>
                                    <p class="mb-0 small">
                                        <strong>
